...
public class ColorScheme {
   ...
   *
   * @param foreColor
   *     The foreground color as an ARGB hex value.
   * @param backColor
   *     The background color as an ARGB hex value.
   */
   ...
   *
   * @param scheme
   *     An integer array <code>{ foreColor, backColor,
