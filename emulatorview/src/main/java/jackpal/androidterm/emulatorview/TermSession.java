...
public class TermSession {
   ...
   *
   * @param data
   *     An array of bytes to write to the terminal.
   * @param offset
   *     The offset into the array at which the data starts.
   * @param count
   ...
   *
   * @param termOut
   *     This session's {@link OutputStream}.
   */
   ...
   *
   * @param termIn
   *     This session's {@link InputStream}.
   */
   ...
   *
   * @param notify
   *     The {@link UpdateCallback} to be invoked on changes.
   */
   ...
   * @param offset
   *     The offset into the buffer where the read data begins.
   * @param count
   ...
   *
   * @param data
   *     The data to be written to the terminal.
   * @param offset
   *     The starting offset into the buffer of the data.
   * @param count
   ...
   *
   * @param scheme
   *     The {@link ColorScheme} to be used (use null for the
   *     default scheme).
   */
   ...
   *
   * @param utf8ModeNotify
   *     The {@link UpdateCallback} to be invoked.
   */
   ...
   *
   * @param callback
   *     The {@link FinishCallback} to be invoked on finish.
   */
  ...
  public interface FinishCallback {
     ...
     *
     * @param session
     *     The <code>TermSession</code> which has finished.
     */
