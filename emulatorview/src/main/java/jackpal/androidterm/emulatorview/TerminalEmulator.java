...
class TerminalEmulator {
   ...
   *
   * @param session
   *     the terminal session the emulator is attached to
   * @param screen
   ...
   * @param scheme
   *     the default color scheme of this emulator
   */
   ...
   *
   * @param c
   *     A char[2] containing either a single UTF-16 char or a surrogate pair to be sent to the screen.
   */
