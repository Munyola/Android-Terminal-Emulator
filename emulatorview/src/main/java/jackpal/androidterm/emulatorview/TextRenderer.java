...
interface TextRenderer {
   ...
   * @param x
   *     Canvas coordinate of the left edge of the whole line.
   * @param y
   *     Canvas coordinate of the bottom edge of the whole line.
   * @param lineOffset
   *     The screen character offset of this text run (0..length of line)
   * @param runWidth
   * @param text
   * @param index
   * @param count
   * @param selectionStyle
   *     True to draw the text using the "selected" style (for clipboard copy)
   * @param textStyle
   * @param cursorOffset
   *     The screen character offset of the cursor (or -1 if not on this line.)
   * @param cursorIndex
   *     The index of the cursor in text chars.
   * @param cursorIncr
   *     The width of the cursor in text chars. (1 or 2)
   * @param cursorWidth
   *     The width of the cursor in screen columns (1 or 2)
   * @param cursorMode
   *     The cursor mode (used to show state of shift/control/alt/fn locks.
   */
