...
class TranscriptScreen implements Screen {
   ...
   * @param screenRows
   *     the height of just the screen, not including the
   ...
   * @param selx2
   *     the text selection end X coordinate, if equals to selx1 don't draw selection
   * @param imeText
   *     current IME text, to be rendered at cursor
   * @param cursorMode
   *     the cursor mode. See TextRenderer.
   */
   ...
   *
   * @param row
   *     The row to check for line-wrap status
