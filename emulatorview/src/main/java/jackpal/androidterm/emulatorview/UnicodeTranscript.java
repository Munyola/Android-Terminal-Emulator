...
class UnicodeTranscript {
   ...
   *
   * @param chars
   *     The array containing the code point in question.
   * @param index
   *     The index into the array at which the code point starts.
   * @return The display width of the Unicode code point.
   */
   ...
   * @param cursor
   *     An int[2] containing the current cursor location; if the
   ...
   * @param shift
   *     The offset of the destination from the source.
   */
  ...
  public void blockSet(int sx, int sy, int w, int h, int val, int style) {
    if (sx < 0 || sx + w > mColumns || sy < 0 || sy + h > mScreenRows) {
      Log.e(TAG,
          "illegal arguments! " + sx + " " + sy + " " + w + " " + h + " " + val + " " + mColumns + " " + mScreenRows);
      throw new IllegalArgumentException();
    }
   ...
   *
   * @param row
   *     The row number to get (-mActiveTranscriptRows..mScreenRows-1)
   * @param x1
   *     The first screen position that's wanted
   * @param x2
   *     One after the last screen position that's wanted
   ...
   *
   * @param row
   *     The row of the character to get.
   * @param column
   *     The column of the character to get.
   * @param charIndex
   *     The index of the character in the column to get
   *     (0 for the first character, 1 for the next, etc.)
   * @param out
   *     The char[] array into which the character will be placed.
   * @param offset
   *     The offset in the array at which the character will be placed.
