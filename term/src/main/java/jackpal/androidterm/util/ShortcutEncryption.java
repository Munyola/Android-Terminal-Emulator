...
public final class ShortcutEncryption {
   ...
   *
   * @param encrypted
   *     The string to decrypt, in the format described above.
   * @param keys
   *     The keys to verify and decrypt with.
   * @return The decrypted data.
   * @throws GeneralSecurityException
   *     if the data is invalid, verification fails, or an error occurs during decryption.
   */
   ...
   *
   * @param data
   *     The string containing the data to encrypt.
   * @param keys
   *     The keys to encrypt and authenticate with.
   ...
   *
   * @throws GeneralSecurityException
   *     if an error occurs during MAC computation.
   */
